...
### [Image-Driven Robot Drawing with Rapid Lognormal Movements](https://doc.gold.ac.uk/autograff/post/papers/rapid_dslm/)
...
- *Artistic/Creative Use* (optional attribution): This system is also rooted in an artistic research and practice component. If you use it for artistic or creative outputs, please consider mentioning/crediting Daniel Berio (@colormotor).
